...
contract('ShareCenter Error Testing', function(accounts) {
  var center, centerAddress, user1, user1Address, user2, user2Address, fakeUser, fakeUserAddress, shareID, groupID, fakeID, emptyGroupID;
  ...
  it("should throw error code 2 when getUser is called from fake user", async function() {
  ...
  it("should throw error code 2 when getPersonalGroupID is called from fake user", async function() {
